...
namespace DZshka
{
    class Encoding
    {
        ...
        static void Main()
        {
            ...
            map.RecordWrite1("A man and woman had been married for more than 60 years. They had shared everything. They had talked about everything.");
            map.RecordWrite2("A man and woman had been married for more than 60 years. They had shared everything. They had talked about everything.");
            map.RecordWrite3("A man and woman had been married for more than 60 years. They had shared everything. They had talked about everything.");
